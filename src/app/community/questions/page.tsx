          ...
          <div className="bg-white dark:bg-ink-800 rounded-2xl shadow-2xl max-w-xl w-full p-5" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <textarea value={body} onChange={(e) => setBody(e.target.value)} className="w-full border border-ink-200 dark:border-ink-600 dark:bg-ink-900 dark:text-ink-100 rounded-md p-2 text-sm min-h-[120px] font-mono" />
              </div>
              <div>
