...
- For math formulas, use LaTeX syntax: inline with single dollar signs $...$ and display with double dollar signs $$...$$
- Example: $E = mc^2$ for inline, $$\\int_0^\\infty e^{-x} dx = 1$$ for display
